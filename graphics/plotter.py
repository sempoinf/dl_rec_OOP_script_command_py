...
# Процесс визуализации (visual_proc): Этот процесс выполняется в основном потоке и отвечает за анимацию графиков с помощью метода animate класса Plotter.
...
# Процесс сбора данных (plotter_proc): Этот процесс запускается в отдельном потоке и отвечает за чтение данных с датчиков через packetHandler и обновление буфера данных data_buff.
